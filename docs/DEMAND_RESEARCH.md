...
**원칙:** v3~v7 결론은 **참고용**. **v8 5단계 확정:** `ktx-mcp` (TAGO, **한국+글로벌 다국어**, 저가·호출량) — [KTX_MCP_SPEC.md](./KTX_MCP_SPEC.md).
...
| 4 | 후보 매트릭스 + 수익 채널 매칭 | ✅ **완료** → [KTX_MCP_SPEC.md](./KTX_MCP_SPEC.md) §11 |
...
- [ ] `docs/SPEC.md` (도구 4개·Non-goals: 예약 금지)
